...
async def delete_record_by_id(message: types.Message):
    keyboard_answer_to_delete_record = types.InlineKeyboardMarkup()
    ...
    keyboard_answer_to_delete_record.add(button_view_records, button_random_recipe)
    keyboard_answer_to_delete_record_with_wrong_format_or_id = types.InlineKeyboardMarkup()
    view_records_button = types.InlineKeyboardButton("View records", callback_data="view_records")
    button_delete_record_by_id = types.InlineKeyboardButton("Delete one record", callback_data="delete_one_record")
    keyboard_answer_to_delete_record_with_wrong_format_or_id.add(view_records_button, button_delete_record_by_id)
    args = message.get_args()
    if not args.isdigit():
        print(message.from_user, ': attempted to delete record in wrong format using the command: /dr', args)
        await message.reply("❌ Please, enter a valid numeric ID to delete a record. 🙏", reply_markup=keyboard_answer_to_delete_record_with_wrong_format_or_id)
        return
    id = int(args)
    deleted = BotDB.delete_record_by_id(id)
    if deleted:
        await message.reply(f"✅ Record with ID {id} has been successfully deleted. 👍",
                            reply_markup=keyboard_answer_to_delete_record)
        print(message.from_user, ": deleted record with id", id, "through the command /delete_record")
    else:
        await message.reply(f"❌ Record with ID {id} was not found. 🤷‍♂️", reply_markup=keyboard_answer_to_delete_record_with_wrong_format_or_id)
...
async def get_random_recipe(message: types.Message):
    ...
    mark_an_error_button_random = types.InlineKeyboardButton("Mark an error", callback_data="mark_an_error")
    leave_a_review_button_random = types.InlineKeyboardButton("Leave a review", callback_data="leave_a_review")
    add_to_favorites_button_random = types.InlineKeyboardButton("Add to favorites from random", callback_data="add_to_favorites_from_random")
    view_records_button_random = types.InlineKeyboardButton("View records", callback_data="view_records")
    ...
    if r.status_code == requests.codes.ok:
        ...
        random_recipe_text = (f"Name of the dish: {recipe} \n\nIngredients: {ingredients}"
...
async def get_recipe(message: types.Message):
    try:
        ...
        if r.status_code == requests.codes.ok:
            ...
            recipe1_text = (f"🍽️ Name of the dish: {recipe1} \n\n📋 Ingredients: {ingredients1}"
            ...
            recipe2_text = (f"🍽️ Name of the dish: {recipe2} \n\n📋 Ingredients: {ingredients2}"
...
async def get_more_recipes(query: types.CallbackQuery):
    try:
        ...
        global recipe5
        global request_recipe
        print(query.from_user, ': completed the request with text in the chat:', request_recipe)
        global recipe3_text
        global recipe4_text
        global recipe5_text
        # write here your api_url and api_key instead of "XXX"
        ...
        view_records_button = InlineKeyboardButton("View records", callback_data="view_records")
        random_recipe_button = InlineKeyboardButton("Random recipe", callback_data="random_recipe_start")
        get_more_recipes_button_2 = InlineKeyboardButton("Get even more recipes of this dish", callback_data="get_even_more_recipes")
        keyboard_mae_lar_atf_vr_rr_3.add(mark_an_error_button, leave_a_review_button, add_to_favorites_button_3, view_records_button, get_more_recipes_button_2, random_recipe_button)
        ...
        keyboard_mae_lar_atf_vr_rr_4.add(mark_an_error_button, leave_a_review_button, add_to_favorites_button_4, view_records_button, get_more_recipes_button_2, random_recipe_button)
        ...
        keyboard_mae_lar_atf_vr_rr_5.add(mark_an_error_button, leave_a_review_button, add_to_favorites_button_5, view_records_button, get_more_recipes_button_2, random_recipe_button)

        if r.status_code == requests.codes.ok:
            recipes_list3 = r.json()[3]
            ...
            recipe3_text = (f"🍽️ Name of the dish: {recipe3} \n\n📋 Ingredients: {ingredients3}"
            ...
            recipe4_text = (f"🍽️ Name of the dish: {recipe4} \n\n📋 Ingredients: {ingredients4}"
            ...
            recipe5_text = (f"🍽️ Name of the dish: {recipe5} \n\n📋 Ingredients: {ingredients5}"
...
@dp.callback_query_handler(text="get_even_more_recipes")
async def get_even_more_recipes(query: types.CallbackQuery):
    try:
        global recipe6
        global recipe7
        global recipe8
        ...
        api_key = 'XXX'
        r = requests.get(api_url, headers={'X-Api-Key': api_key})
        keyboard_mae_lar_atf_vr_rr_6 = types.InlineKeyboardMarkup(row_width=2)
        mark_an_error_button = InlineKeyboardButton("Mark an error", callback_data="mark_an_error")
        leave_a_review_button = InlineKeyboardButton("Leave a review", callback_data="leave_a_review")
        add_to_favorites_button_6 = InlineKeyboardButton("Add to favorites 7th recipe", callback_data="add_to_favorites_main_6")
        view_records_button = InlineKeyboardButton("View records", callback_data="view_records")
        random_recipe_button = InlineKeyboardButton("Random recipe", callback_data="random_recipe_start")
        keyboard_mae_lar_atf_vr_rr_6.add(mark_an_error_button, leave_a_review_button, add_to_favorites_button_6, view_records_button, random_recipe_button)
        keyboard_mae_lar_atf_vr_rr_7 = types.InlineKeyboardMarkup(row_width=2)
        add_to_favorites_button_7 = InlineKeyboardButton("Add to favorites 8th recipe", callback_data="add_to_favorites_main_7")
        keyboard_mae_lar_atf_vr_rr_7.add(mark_an_error_button, leave_a_review_button, add_to_favorites_button_7, view_records_button, random_recipe_button)
        keyboard_mae_lar_atf_vr_rr_8 = types.InlineKeyboardMarkup(row_width=2)
        add_to_favorites_button_8 = InlineKeyboardButton("Add to favorites 9th recipe", callback_data="add_to_favorites_main_8")
        keyboard_mae_lar_atf_vr_rr_8.add(mark_an_error_button, leave_a_review_button, add_to_favorites_button_8, view_records_button, random_recipe_button)

        if r.status_code == requests.codes.ok:
            recipes_list6 = r.json()[6]
            recipe6 = recipes_list6["title"]
            ingredients6 = recipes_list6["ingredients"]
            instructions6 = recipes_list6["instructions"]
            servings6 = recipes_list6["servings"]
            recipe6_text = (f"🍽️ Name of the dish: {recipe6} \n\n📋 Ingredients: {ingredients6}"
                                f"\n\n📝 Instructions: {instructions6} \n\n👥 Servings: {servings6}")

            await query.message.reply(f"Please, your seventh recipe!\n \n🍽️ Name of the dish: {recipe6} \n\n📋 Ingredients: {ingredients6}"
                                f"\n\n📝 Instructions: {instructions6} \n\n👥 Servings: {servings6}", reply_markup=keyboard_mae_lar_atf_vr_rr_6)

            recipes_list7 = r.json()[7]
            recipe7 = recipes_list7["title"]
            ingredients7 = recipes_list7["ingredients"]
            instructions7 = recipes_list7["instructions"]
            servings7 = recipes_list7["servings"]
            recipe7_text = (f"🍽️ Name of the dish: {recipe7} \n\n📋 Ingredients: {ingredients7}"
                                f"\n\n📝 Instructions: {instructions7} \n\n👥 Servings: {servings7}")

            await query.message.reply(
                f"Please, your eighth recipe!\n \n🍽️ Name of the dish: {recipe7} \n\n📋 Ingredients: {ingredients7}"
                f"\n\n📝 Instructions: {instructions7} \n\n👥 Servings: {servings7}", reply_markup=keyboard_mae_lar_atf_vr_rr_7)

            recipes_list8 = r.json()[8]
            recipe8 = recipes_list8["title"]
            ingredients8 = recipes_list8["ingredients"]
            instructions8 = recipes_list8["instructions"]
            servings8 = recipes_list8["servings"]
            recipe8_text = (f"🍽️ Name of the dish: {recipe8} \n\n📋 Ingredients: {ingredients8}"
                f"\n\n📝 Instructions: {instructions8} \n\n👥 Servings: {servings8}")

            await query.message.reply(
                f"Please, your ninth recipe!\n \n🍽️ Name of the dish: {recipe8} \n\n📋 Ingredients: {ingredients8}"
                f"\n\n📝 Instructions: {instructions8} \n\n👥 Servings: {servings8}", reply_markup=keyboard_mae_lar_atf_vr_rr_8)

    except:
        await query.message.reply("❌ Check the correctness of the name of the dish or the command, or enter the request again please 🙏 ",
                        )
    print(query.from_user, ': pressed the button "Get more recipes of this dish" , 7th recipe is: ', recipe6)
    print(query.from_user, ': pressed the button "Get more recipes of this dish" , 8th recipe is: ', recipe7)
    print(query.from_user, ': pressed the button "Get more recipes of this dish" , 9th recipe is: ', recipe8)
...
async def view_records_callback(query: types.CallbackQuery):
    ...
    if not entries:
        ...
        keyboard_answer_to_view_records_not_entries.add(button_random_recipe_view_records)
...
async def record_add_to_favorites_random_callback(query: types.CallbackQuery):
    ...
    print(query.from_user, ': pressed the button "Add to favorites from random with result: "', name_of_the_dish)
...
@dp.callback_query_handler(text="add_to_favorites_main_6")
async def record_add_to_favorites_main6_callback(query: types.CallbackQuery):
    try:
        keyboard_answer_to_add_to_favorites_main_6 = types.InlineKeyboardMarkup()
        button_view_records_main_6 = types.InlineKeyboardButton("View records", callback_data="view_records")
        button_random_recipe_main_6 = types.InlineKeyboardButton("Random recipe", callback_data="random_recipe_start")
        keyboard_answer_to_add_to_favorites_main_6.add(button_view_records_main_6, button_random_recipe_main_6)
        operation = 'favorites'
        value = recipe6_text
        BotDB.add_record(query.from_user.id, operation, value)
        await query.message.reply('✅ The record already has been added to favorites! 🌟',reply_markup=keyboard_answer_to_add_to_favorites_main_6)
    except:
        await query.message.reply("❌ Check the correctness of the dish name or command. Please, try entering your request again. 🙏 ")
    print(query.from_user, ': pressed the button "Add to favorites 7th recipe" with result: ', recipe6)


@dp.callback_query_handler(text="add_to_favorites_main_7")
async def record_add_to_favorites_main7_callback(query: types.CallbackQuery):
    try:
        keyboard_answer_to_add_to_favorites_main_7 = types.InlineKeyboardMarkup()
        button_view_records_main_7 = types.InlineKeyboardButton("View records", callback_data="view_records")
        button_random_recipe_main_7 = types.InlineKeyboardButton("Random recipe", callback_data="random_recipe_start")
        keyboard_answer_to_add_to_favorites_main_7.add(button_view_records_main_7, button_random_recipe_main_7)
        operation = 'favorites'
        value = recipe7_text
        BotDB.add_record(query.from_user.id, operation, value)
        await query.message.reply('✅ The record already has been added to favorites! 🌟',reply_markup=keyboard_answer_to_add_to_favorites_main_7)
    except:
        await query.message.reply("❌ Check the correctness of the dish name or command. Please, try entering your request again. 🙏 ")
    print(query.from_user, ': pressed the button "Add to favorites 8th recipe" with result: ', recipe7)


@dp.callback_query_handler(text="add_to_favorites_main_8")
async def record_add_to_favorites_main8_callback(query: types.CallbackQuery):
    try:
        keyboard_answer_to_add_to_favorites_main_8 = types.InlineKeyboardMarkup()
        button_view_records_main_8 = types.InlineKeyboardButton("View records", callback_data="view_records")
        button_random_recipe_main_8 = types.InlineKeyboardButton("Random recipe", callback_data="random_recipe_start")
        keyboard_answer_to_add_to_favorites_main_8.add(button_view_records_main_8, button_random_recipe_main_8)
        operation = 'favorites'
        value = recipe8_text
        BotDB.add_record(query.from_user.id, operation, value)
        await query.message.reply('✅ The record already has been added to favorites! 🌟',reply_markup=keyboard_answer_to_add_to_favorites_main_8)
    except:
        await query.message.reply("❌ Check the correctness of the dish name or command. Please, try entering your request again. 🙏 ")
    print(query.from_user, ': pressed the button "Add to favorites 9th recipe" with result: ', recipe8)
